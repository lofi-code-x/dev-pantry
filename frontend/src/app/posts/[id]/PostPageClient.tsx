                ...
                <>
                    <section className="mb-6 rounded-xl border border-border bg-card p-6 shadow-sm">
                        <div className={cn(hasTopPanel && "border-b border-border pb-4")}>
                            ...
                            <div className="mt-2 flex flex-wrap items-center justify-between gap-3 text-xs text-muted-fg">
                                    ...
                                    >
                                        ...
                                        {q.question_type === "text_input" ? (
                                            ...
                                            <div className="space-y-2">
                                                {q.options.map((opt) => (
                                                    <label key={opt.id} className="flex items-center gap-2 text-sm text-fg">
                                                        <input
                                                            type="radio"
                                                            name={`q-${q.id}`}
